...
INTEGER                  :: nstepmax
REAL(KIND=wp), PARAMETER :: dt           = 86400._wp / 4._wp !/ 10._wp
...
REAL(KIND=wp), DIMENSION(nbox) :: export, eratio, pge
REAL(KIND=wp)                  :: alpha 
...
REAL(KIND=wp)                  :: rFeC_pb, m_l, m_q, kappa, mu0, pge_deep, f_T
...
! Prokaryotic growth rate dependence on temperature, exponential factor
   f_T = 1.0_wp   ! 1.066_wp for T-dependence, 1.0_wp for no T-dependence
